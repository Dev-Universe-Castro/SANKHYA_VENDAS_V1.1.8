    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-shrink-0 bg-white border-b shadow-sm mt-0">
        ...
        <Tabs defaultValue="cabecalho" className="w-full">
          <TabsList className="grid w-full grid-cols-5 h-auto gap-0.5 rounded-none bg-gray-100">
            <TabsTrigger value="cabecalho" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs md:text-sm px-2 md:px-3 py-2 md:py-2.5 rounded-none">
              Cabeçalho
            </TabsTrigger>
            <TabsTrigger value="catalogo" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs md:text-sm px-2 md:px-3 py-2 md:py-2.5 rounded-none">
              Catálogo
            </TabsTrigger>
            <TabsTrigger value="impostos" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs md:text-sm px-2 md:px-3 py-2 md:py-2.5 rounded-none">
              Impostos
            </TabsTrigger>
            <TabsTrigger value="resumo" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs md:text-sm px-2 md:px-3 py-2 md:py-2.5 rounded-none">
              Resumo
            </TabsTrigger>
            <TabsTrigger value="relatorio" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs md:text-sm px-2 md:px-3 py-2 md:py-2.5 rounded-none">
              Relatório
            </TabsTrigger>
          </TabsList>

        {/* Conteúdo das Abas - Scrollável */}
          <div className="h-[calc(100vh-280px)] md:h-[calc(95vh-280px)] overflow-y-auto scrollbar-hide pb-4">
            {/* Aba Cabeçalho */}
            <TabsContent value="cabecalho" className="space-y-3 p-4 mt-0">
        ...
        <TabsContent value="catalogo" className="space-y-3 p-4 mt-0">
        ...
        {/* Aba Impostos */}
        <TabsContent value="impostos" className="space-y-3 p-4 mt-0">
          <Card className="border-green-200">
            <CardHeader className="px-3 md:px-4 py-2 md:py-3 bg-gradient-to-r from-green-50 to-green-100">
              <div className="flex items-center gap-2">
                <div className="w-1 h-5 bg-green-600 rounded"></div>
        ...
        {showGraficos && (
          <TabsContent value="resumo" className="space-y-3 p-4 mt-0">
            {itens.length === 0 ? (
        ...
        {/* Aba Relatório */}
        <TabsContent value="relatorio" className="space-y-3 p-4 mt-0">
          <Card className="border-green-200">
            <CardHeader className="px-3 md:px-4 py-2 md:py-3 bg-gradient-to-r from-green-50 to-green-100">
              <div className="flex items-center gap-2">
                <div className="w-1 h-5 bg-green-600 rounded"></div>
      ...
      <div className="md:hidden fixed bottom-20 right-4 z-40">
        <Button
          onClick={(e) => {
            e.preventDefault()
            e.stopPropagation()
            console.log('🛒 [CARRINHO FLUTUANTE] Abrindo carrinho - Total itens:', itens?.length)
            setShowCarrinhoModalPedido(true)
          }}
